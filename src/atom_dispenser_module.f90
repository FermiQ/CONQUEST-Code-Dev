...
contains
  ...
  !!  INPUTS
  !!    x: x-coordinate of the atom (double precision real)
  !!    y: y-coordinate of the atom (double precision real)
  !!    z: z-coordinate of the atom (double precision real)
  !!  OUTPUTS
  !!    px: x-index of the partition (integer)
  !!    py: y-index of the partition (integer)
  !!    pz: z-index of the partition (integer)
  !!    ind_part: index of the partition (integer)
  !!    atom_id: ID of the atom (integer), used for debugging
  !!  USES
  !!
  !!  AUTHOR
  !!   Michiaki Arita
...
!   endif
  ...
  !!  INPUTS
  !!    ind_part: array to store the partition index for each atom (integer array)
  !!  USES
